...
cd /var/www/html
wget https://download.nextcloud.com/server/releases/nextcloud-24.0.1.zip && sudo unzip nextcloud-24.0.1.zip && sudo rm nextcloud-24.0.1.zip
chown -R www-data:www-data /var/www/html/nextcloud

wget https://raw.githubusercontent.com/Heidelberger2000/Scripts/main/Linux/nextcloud/nextcloud.conf?token=GHSAT0AAAAAAB4DAGVGDVI4YGVGG7WF73GWZAINJJQ && sudo mv nextcloud.conf /etc/apache2/sites-available/
